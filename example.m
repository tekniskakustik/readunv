...
%
%
%      [STATE, DATACELL] = READUNV(FILEPATH, SKIPDATA)
%
%      NB: TWO OUTPUTS AND FILEPATH ARE REQUIRED, SKIPDATA IS OPTTIONAL
%          STATE: DOUBLE, SEE STATE FLAGS BELOW
%          DATACELL: CELL ARRAY, UNV-BLOCKS
%          FILEPATH: CHAR, ABSOLUTE OR RELATIVE PATH
%          SKIPDATA (OPT): DOUBLE, 1 OR 0, TO ONLY READ METADATA, DEFAULT = 0
%
%
